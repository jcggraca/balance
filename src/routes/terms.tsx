...
function RouteComponent() {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Balance.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            {' '}
            <a
              href="https://my-personal-finance-ochre.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://my-personal-finance-ochre.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: mail@joaograca.dev</li>
      </ul>
    </div>
  )
}
